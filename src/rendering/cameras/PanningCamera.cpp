...
void PanningCamera::update(const Window& window, float dt, bool controls_enabled) {
    ...
    // Task A: Set camera to rotate around the focus point
    ...
    glm::vec3 new_position = focus_point - distance * direction;
    view_matrix = glm::lookAt(new_position, focus_point, glm::vec3{0.0f, 1.0f, 0.0f});
